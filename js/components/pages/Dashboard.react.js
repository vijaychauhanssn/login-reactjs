    ...
    return (
      <article>
        <section className="text-section">
          <h1>Dashboard</h1>
          <p>Welcome, you are logged in! To have a look at the code behind this application, go to <a href="https://github.com/vijaychauhanssn/login-reactjs">Github</a>. To run it locally:</p>
          <ol>
            <li><p>Clone the repo using <code>git clone git@github.com:vijaychauhanssn/login-reactjs</code></p></li>
